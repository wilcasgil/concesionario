<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addConductor.aspx.cs" Inherits="Presentacion.addConductor" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="addTipoConductor.aspx">Registro Tipo Conductor</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="addConductor.aspx">Registro Conductor<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <form id="form" runat="server">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="txtTipo_Licencia">Tipo licencia</label>
                    <asp:TextBox ID="txtTipo_Licencia" runat="server" class="form-control"></asp:TextBox> 
                </div>
                <div class="form-group col-md-4">
                    <label for="txtId_Vehiculo">Id vehiculo</label>
                    <div class="dropdown">
                            <asp:DropDownList ID="DropDownListIdVehiculo" runat="server" class="btn btn-light dropdown-item"></asp:DropDownList>
                        </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="txtId_Tipo_Vehiculo">Id tipo conductor</label>
                    <div class="dropdown">
                            <asp:DropDownList ID="DropDownListIdTipoConductor" runat="server" class="btn btn-light dropdown-item"></asp:DropDownList>
                        </div>
                </div>
            </div>
            <div class="form-row ">
