<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addContrato.aspx.cs" Inherits="Presentacion.addContrato" %>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="addContrato.aspx">Contrato<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <br />
        <form id="form" runat="server">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="txtId_Tipo_Vehiculo">Id tipo vehiculo</label>
                    <div class="dropdown">
                            <asp:DropDownList ID="DropDownListIdTipoVehiculo" runat="server" class="btn btn-light dropdown-item"></asp:DropDownList>
                        </div>
                </div>
            </div>
            <div class="form-row ">
