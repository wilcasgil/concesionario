<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addTipoVehiculos.aspx.cs" Inherits="Presentacion.addVehiculos" %>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="addTipoVehiculos.aspx">Registro Tipo Vehiculos <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
