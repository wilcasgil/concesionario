<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addVehiculos.aspx.cs" Inherits="Presentacion.addVehiculos1" %>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="addVehiculos.aspx">Registro Vehiculos <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
